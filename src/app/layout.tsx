...
export const metadata: Metadata = {
  ...
  description: 'Para harcamadan hizmet al ve ver. Zamanını takas et, yeteneklerini paylaş ve toplulukla büyü.',
  keywords: ['houra', 'zaman bankası', 'yetenek takası', 'beceri paylaşımı', 'saat kredisi', 'dayanışma'],
  ...
  openGraph: {
    ...
    description: 'Yeteneklerini zamanla takas et. Para harcamadan hizmet almanın en akıllı yolu.',
    siteName: 'HOURA',
    images: [{
